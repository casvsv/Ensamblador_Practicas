...
_start:
	...
	;**************Imprimir mensaje del primer número***********
 ...
 menu:
	...
	;***********Comparación************
	;Comparar el valor ingresado por el usuario, para saber que operación se realizará
	; JE = jpm si existe es igual a, salta cuando los valores de los 2 operandos son iguales, ZF = 1, CF = 0 
